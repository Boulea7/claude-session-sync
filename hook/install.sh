...
echo -e "  2. Create ${YELLOW}.claude/sessions.json${NC} in your project directory"
echo -e "  3. The hook will auto-inject session state before Codex/Gemini calls"
echo ""
echo -e "For project-level setup, run:"
echo -e "  ${BLUE}mkdir -p .claude && cp ~/.claude/sessions.json .claude/${NC}"
echo ""
